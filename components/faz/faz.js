    ...
    (stor) => {
        ...
        if (isSiteEnabled(window.location.href) && isPaidContent) {
            ...
            const downloadDone = (e) => {
                ...
                d.getElementsByClassName("atc-Text js-atc-Text")[0].innerHTML = '<p class="atc-TextParagraph">' + JSON.parse(mReq.response.getElementById("schemaOrgJson").innerHTML).ArticleBody + "</p>";
